...
public class PartTwoLessonTwoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_part_two_lesson_two);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PartTwoLessonTwoActivity.this, UnitOneActivity.class);
        ...
        btnOption1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PartTwoLessonTwoActivity.this, "Incorrect answer", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnOption3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PartTwoLessonTwoActivity.this, "Correct answer", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PartTwoLessonTwoActivity.this, PartThreeLessonTwoActivity.class);
                startActivity(intent);
                finish();
            }
        });
