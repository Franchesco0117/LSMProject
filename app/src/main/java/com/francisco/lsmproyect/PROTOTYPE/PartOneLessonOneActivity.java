...
public class PartOneLessonOneActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_part_one_lesson_one);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PartOneLessonOneActivity.this, UnitOneActivity.class);
        ...
        btnOption1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PartOneLessonOneActivity.this, "Incorrect answer", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnOption4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PartOneLessonOneActivity.this, "Correct answer", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PartOneLessonOneActivity.this, PartTwoLessonOneActivity.class);
                startActivity(intent);
                finish();
            }
        });
