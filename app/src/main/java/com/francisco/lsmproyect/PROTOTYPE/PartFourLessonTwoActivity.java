...
public class PartFourLessonTwoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_part_four_lesson_two);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PartFourLessonTwoActivity.this, UnitOneActivity.class);
        ...
        btnOption1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PartFourLessonTwoActivity.this, "Incorrect answer", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnOption2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PartFourLessonTwoActivity.this, "Correct answer", Toast.LENGTH_SHORT).show();
            }
        });
