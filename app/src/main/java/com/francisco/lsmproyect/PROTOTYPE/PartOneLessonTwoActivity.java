...
public class PartOneLessonTwoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_part_one_lesson_two);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PartOneLessonTwoActivity.this, UnitOneActivity.class);
        ...
        btnOption1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PartOneLessonTwoActivity.this, "Correct answer", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnOption2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PartOneLessonTwoActivity.this, "Incorrect answer", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PartOneLessonTwoActivity.this, PartTwoLessonTwoActivity.class);
                startActivity(intent);
                finish();
            }
        });
